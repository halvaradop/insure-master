    ...
    return (
        <footer className="w-full bg-gray">
            <section className="w-11/12 mx-auto">
                <figure className="pt-24 pb-6 px-5 flex items-center flex-col gap-y-4 relative border-b border-blue">
                    <img className="relative z-10" src={logo} alt="logo icon" />
                    <figure className="flex items-center gap-x-4 relative z-10">
                ...
                <section className="mt-8 mb-14 grid gap-y-8">
